...
var LinePropTypes = _objectSpread(_objectSpread({}, commonPropTypes), {}, {
...
var LineDefaultProps = _objectSpread(_objectSpread({}, commonDefaultProps), {}, {
...
var LineCanvasDefaultProps = _objectSpread(_objectSpread({}, commonDefaultProps), {}, {
  ...
  return React.useMemo(function () {
    return series.reduce(function (acc, serie) {
      return [].concat(_toConsumableArray(acc), _toConsumableArray(serie.data.filter(function (datum) {
        ...
        point.data = _objectSpread$1(_objectSpread$1({}, datum.data), {}, {
...
var useLine = function useLine(_ref9) {
  ...
  var series = React.useMemo(function () {
    return rawSeries.map(function (serie) {
      return _objectSpread$1(_objectSpread$1({}, serie), {}, {
  ...
  return React__default.createElement(core.SvgWrapper, {
    ...
    if (typeof layer === 'function') {
      return React__default.createElement(React.Fragment, {
        key: i
      }, layer(_objectSpread$2(_objectSpread$2({}, props), {}, {
    ...
    layers.forEach(function (layer) {
      ...
      if (layer === 'legends') {
        ...
        legends$1.forEach(function (legend) {
          legends.renderLegendToCanvas(ctx, _objectSpread$3(_objectSpread$3({}, legend), {}, {
            data: legend.data || legendData,
            containerWidth: innerWidth,
            containerHeight: innerHeight,
            theme: theme
